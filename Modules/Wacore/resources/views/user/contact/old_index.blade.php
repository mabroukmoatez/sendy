			...
			<div class="col">
				<div class="card card-stats">
					<div class="card-body">
						...
						</p><h5 class="card-title  text-muted mb-0">{{ __('Total des contacts') }}</h5>
						<p></p>
					</div>
				</div>
			</div>
...
{{-- NEW MODAL FOR IMPORT FROM DEVICE --}}
