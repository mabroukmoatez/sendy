  ...
  <div class="col-xl-3 col-md-6">
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Total des appareils') }}</h5>
  ...
  <div class="col-xl-3 col-md-6">
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Total des messages') }}</h5>
  ...
  <div class="col-xl-3 col-md-6">
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Planifications en attente') }}</h5>
   ...
   <div class="col-xl-3 col-md-6">
    <div class="card card-stats">
      ...
      <div class="card-body">
        <div class="row">
          <div class="col">
            <h5 class="card-title text-uppercase text-muted mb-0">{{ __('Total des contacts') }}</h5>
  ...
  <div class="col-sm-6">
    <div class="card">
       <div class="card-header bg-transparent">
        <h4 class="card-header-title">{{ __('Transactions de messages') }}</h4>
        <div class="card-header-action">
          <select class="form-control" id="period" >
            <option value="7">{{ __('7 derniers jours') }}</option>
            <option value="1">{{ __('Aujourd\'hui') }}</option>
            <option value="30">{{ __('30 derniers jours') }}</option>
          </select>
        </div>
      </div>
      <div class="card-body">
