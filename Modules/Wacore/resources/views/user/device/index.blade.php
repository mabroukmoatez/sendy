...
<div class="row justify-content-center">
   <div class="col-12">
         ...
         <div class="col">
            <div class="card card-stats">
               <div class="card-body">
                  ...
                  <h5 class="card-title  text-muted mb-0">{{ __('Total des appareils') }}</h5>
                  <p></p>
               </div>
            </div>
         </div>
      ...
      <div class="col-xl-4 col-md-6 d-flex">
         <div class="card border-0 flex-fill d-flex align-items-center justify-content-center bg-gradient-primary text-white shadow">
            {{-- Removed min-height here as flex-fill should handle height. If you need a minimum height, consider applying it to the card's container or via CSS. --}}
            <div class="card-body text-center d-flex flex-column align-items-center justify-content-center"> {{-- Added d-flex, flex-column, align-items-center, justify-content-center here --}}
                  <a href="{{ route('user.device.create') }}" class="btn btn-primary btn-icon-only rounded-circle btn-lg">
                     <i class="fas fa-plus"></i>
                  </a>
                  <p class="mt-3 mb-0 text-white font-weight-600">{{ __('Add New Device') }}</p>
            </div>
         </div>
      </div>
      @else
