		...
		<div class="row">
			...
			<div class="card">
				<div class="card-header row" style="display: flex; justify-content: space-between; align-items: center;">
					<h4 class="text-left col-6" style="font-size: 20px; margin-bottom: 0;">{{ __('Models') }}</h4>
					<ul class="nav nav-pills custom-btn-div">
						<li class="nav-item  ">
							<a href="{{ route('user.template.create') }}" class="nav-link active btn btn-sm"><i class="fas fa-plus"></i> {{ __('Create a template') }}</a>
						</li>
					</ul>
				</div>
				<div class="card-body">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12 table-responsive">
						<table class="table col-12" style=" min-height: 53vh; ">
							<thead>
								<tr>
