...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => ['auth','user','saas']], function (){
   ...
   Route::get('/get-messages/{device_uuid}/{jid}', [USER\ChatController::class,'getChatMessages'])->name('get.messages');
   ...
   //added 03-07-2025
   Route::post('contact/bulk-group-change', [USER\ContactController::class, 'bulkGroupChange'])->name('contact.bulk.group.change');
