			...
			<div class="col">
				<div class="card card-stats">
					<div class="card-body">
						...
						</p><h5 class="card-title  text-muted mb-0">{{ __('Total des messages') }}</h5>
						<p></p>
					</div>
				</div>
			</div>
				...
				<form action="" class="card-header-form">
					<div class="input-group">
						...
						<select class="form-control" name="type">
							...
							<option value="to" @if($type == 'to') selected="" @endif>{{ __('Message à') }}</option>
				...
				<table class="table align-items-center table-flush">
					<thead class="thead-light">
						<tr>
							...
							<th class="col-2">{{ __('Message à') }}</th>
					...
					<tbody class="list">
						...
						<tr>
							...
							<td class="text-center">
								{{ $transaction->template != null ? __('Template') : __('Texte brut') }}
							</td>
