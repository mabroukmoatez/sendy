...
<head>
  ...
  <style>
    #sidenav-collapse-main .navbar-nav .nav-link.active {
      color : #1937e4 !important;
    }
    .collapse.show {
    ...
    .sidenav.navbar-light .scrollbar-inner {
      background-color : #13193D !important;
    }
    .sidenav.navbar-light .nav-link-text {
      color : #fff !important
    }
    .sidenav.navbar-light .navbar-nav .nav-link {
      color : #fff !important
    }
    .sidenav #sidenav-collapse-main .navbar-nav .nav-link.active{
      color : #fff !important
    }
     #navbar-envoyer-un-message .nav-link.active {
