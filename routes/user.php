...
Route::group(['prefix' => 'user', 'as' => 'user.', 'middleware' => ['auth','user','saas']], function (){
   ...
   Route::post('/device-statics',               [USER\DeviceController::class,'deviceStatics']);
    ...
    Route::get('/device/{uuid}/import-chats-contacts', [USER\DeviceController::class, 'importChatContacts'])->name('device.import_chat_contacts');
    Route::post('/device/{uuid}/process-import-chats-contacts', [USER\DeviceController::class, 'processImportChatContacts'])->name('device.process_import_chat_contacts');
   ...
   Route::post('/contacts/import-from-device',  [USER\ContactController::class,'importContactsFromDevice'])->name('contact.import-from-device');
