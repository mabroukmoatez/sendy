...
Route::get('/webhook/whatsender', function (Request $request) {
    Log::info('Incoming Webhook Test Request:', [
    ...
    // Return a success response, as webhooks usually expect a 200 OK
    return response()->json(['status' => 'received', 'message' => 'Webhook data logged successfully'], 200);
});